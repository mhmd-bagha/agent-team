...
mkdir -p "$TARGET/.claude/agents" "$TARGET/.claude/skills/team-run" "$TARGET/.claude/skills/final-verification" "$TARGET/memory" "$TARGET/docs"
...
cp "$ROOT/docs/JEV.md" "$TARGET/docs/JEV.md"
